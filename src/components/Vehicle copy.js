  ...
  return (
    <div className="map">
     ...
     {/*    {props.vehicle.length === 0 && <h1>Vehículo: Cargando...</h1>}
        ...
        <h1>Vehículo: {props.id}</h1>
{/*         {props.doorStatus.length === 0 && (
          <h1>Status de la puerta: Cargando...</h1>
        )}
        {props.doorStatus.length !== 0 && (
          <h1>Status de la puerta: {props.doorStatus}</h1>
        )} */}
        <h1>Status de la puerta: {props.door_status}</h1>
  {/*       {props.doorStatus.length === 0 && (
          <h1>Tiempo con la puerta abierta: Cargando...</h1>
        )}
        {props.doorStatus.length !== 0 && (
